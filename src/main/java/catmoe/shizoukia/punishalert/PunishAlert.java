    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (command.getName().toLowerCase()) {
            case "punishalert":
                ...
                // 检查玩家是否拥有特定权限
                // *: 很好的实践 但实际上在plugin.yml中就可以指定插件权限 但也请考虑if (!sender.hasPermission("permission")) { return true }
                if (sender.hasPermission("punishalert.sendmessage")) {
                    ...
                    Bukkit.getServer().dispatchCommand(CONSOLE, c);
                } else {
            ...
            case "wipealert":
                ...
                if (sender.hasPermission("punishalert.sendmessage")) {
                    ...
                    // 稍微有些糟糕的实践注意: 如果reason需要捕获后面的更多内容 则可能需要使用StringBuilder append之后的内容
